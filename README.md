...
- protocol 지향적 설계하기
    - 당장 프로젝트에서 사용되지 않더라도 미래의 확장을 고려하여 Deck, Card, Player protocol 생성
- 타입 선언하기
    - 카드 숫자가 범위를 벗어나는 것을 막기 위해 Int 타입을 사용하지 않고 Number라는 enum타입을 생성
- 객체 속성들 접근제어자 지정하기
    - 싱글톤 객체를 사용하지 않는 모든 class의 속성들을 private으로 설정하고 private(set)을 활용하여 값을 받아올 수만 있도록 설정
    - 객체의 값을 바꿔야 할 경우는 메서드 사용
    ```swift
...
|3명|4명|5명|
|---|---|---|
|<img width="300" src="Simulator Screenshot - iPhone 14 Pro - 2023-07-10 at 00.36.00.png">|
<img width="300" src="Simulator Screenshot - iPhone 14 Pro - 2023-07-10 at 00.36.03.png">|
<img width="300" src="Simulator Screenshot - iPhone 14 Pro - 2023-07-10 at 00.36.06.png">|

* * *   


### 회고 💭
싱글톤 패턴으로 대부분의 객체를 생성하였는데 이렇게 구현하니 싱글톤 객체에 접근하는 객체를 관리하고 추적하기 힘들고, 여러 기기에서 동시에 실행되는 경우를 고려하지 않았다는 단점을 발견하였다. 싱글톤 패턴 말고 다른 패턴으로도 구현하는 방법도 사용해봐야겠다.     
함수의 매개변수로 받아온 값에 따라 다르게 처리하며 객체지향 프로그래밍을 구현하였는데 프로토콜을 통해서도 구현해봐야겠다.    
로직뿐만 아니라 뷰들도 중복되는 코드를 없애보자!!
